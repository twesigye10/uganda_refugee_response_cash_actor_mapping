...
server <- function(input, output, session) {
    ...
    observeEvent(input$map_shape_click,{
        ...
        if(!is.null(click)){
            ...
            filter_original_cash_data <- filterCashDataByDistrict(df_data, "Location_District", click_district)
    ...
    observeEvent(input$fs_map_shape_click,{
        ...
        if(!is.null(click)){
            ...
            # update year selection
            fs_filter_original_cash_data <- filterCashDataByDistrict(fs_df_data, "location_District", click_district)
