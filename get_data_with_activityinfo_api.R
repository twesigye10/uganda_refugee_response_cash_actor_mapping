...
# "Select Month"= "[Select Month]",
df_environment_protection_and_restoration <- queryTable("cjtzjhzf4c",
                                                        "Partner Name" = "a19026629290000000007.P00000102950000000001",
                                                        "Location District" = "i1475732303.i0219912987",
                                                        "Location Type" = "i1475732303.i0610240747",
                                                        "Location Name" = "i1475732303.i0098724746",
                                                        "Location description (e.g Zone)" = "i0190156265",
                                                        "Parent ID" = "@parent",
                                                        "Select Month"= "[Select Month]",
                                                        "Select Quarter" = "czfp72hkmvzpeeq1r",
                                                        "Training type done" = "Q1479387418",
                                                        "Number of trainings" = "i1477078925",
                                                        "Beehives provided" = "i1477656048",
                                                        "Mushroom kits provided" = "i1477463673",
                                                        "Fruit seedlings provided" = "i1482465409",
                                                        "Select Implementation Type" = "Q1484004405",
                                                        "Select Funding Source(s)" = "Q1483234907",
                                                        "Please specify funding source(s):" = "i1487467145",
                                                        "Select Beneficiary Type" = "Q1486505273",
                                                        "Individuals supported/trained (Female <15)" = "i1483042533",
                                                        "Individuals supported/trained (Male <15)" = "i1481888286",
                                                        "Individuals supported/trained (Female 15-17)" = "i1481695911",
                                                        "Individuals supported/trained (Male 15-17)" = "i1482273035",
                                                        "Individuals supported/trained (Female 18-35)" = "i1482080660",
                                                        "Individuals supported/trained (Male 18-35)" = "i1481118788",
                                                        "Individuals supported/trained (Female 36-59)" = "i1480926414",
                                                        "Individuals supported/trained (Male 36-59)" = "i1481503537",
                                                        "Individuals supported/trained (Female 60+)" = "i1481311162",
                                                        "Individuals supported/trained (Male 60+)" = "i1480349290",
                                                        "Individuals supported/trained (Total)" = "i1525998763",
