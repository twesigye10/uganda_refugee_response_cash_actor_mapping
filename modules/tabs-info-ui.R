...
cbiInfoUI <- function(id){
  
              div(class="read-me-div",
                  
                  h2("CBI for Basic Needs"),
                  div(class="page-text",
...
eaeInfoUI <- function(id){
  
              div(class="read-me-div",
                  
                  h2("Environment and Energy"),
                  div(class="page-text",
...
elsInfoUI <- function(id){
  
              div(class="read-me-div",
                  
                  h2("Emergency Livelihood Support "),
                  div(class="page-text",
